...
def length
	puts "Il y a #{@array_handle.length} journalistes"
end
...
def handle_number
	...
	puts "#{i} handle contiennent des numéros"
end

# Combien d'handle contiennent les 4 lettres du prénom "Aude" 
def handle_aude
	i = 0
	@array_handle.each do |handle|
	...
	puts "#{i} handle contiennent les 4 lettres du prenom Aude"
end
...
def handle_up
	...
	puts "#{i} commencent par une majuscule"
end
...
def handle_under
	...
	puts "Il y a #{i} _ dans les pseudos confondus"
end

# Trie la liste de handle par ordre alphabétique
def tri
	array = @array_handle.sort_by { |handle| handle.downcase }
	return array
end
